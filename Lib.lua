...
function LuminorLib:CreateWindow(titleText, uiName, watermarkText, themeName, bgName, options)
    ...
    function Window:CreateTab(text, iconName)
        ...
        function Tab:CreateDropdown(text, options, default, neonColor, iconName, callback)
            ...
            DropContainer.Size = UDim2.new(1, -12, 0, 32)
            DropContainer.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
            DropContainer.BackgroundTransparency = hasBackground and 0.5 or 0
            DropContainer.ClipsDescendants = true
            DropContainer.Parent = Scroll
            Instance.new("UICorner", DropContainer).CornerRadius = UDim.new(0, 8)
            Instance.new("UIStroke", DropContainer).Color = Color3.fromRGB(51, 51, 51)
            ...
            MainBtn.MouseButton1Click:Connect(function()
                ...
                TweenService:Create(DropContainer, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
            ...
            for _, option in ipairs(options) do
                ...
                OptBtn.MouseButton1Click:Connect(function()
                    ...
                    SelectedLabel.Text = tostring(selected)
                    isDropped = false
                    TweenService:Create(DropContainer, TweenInfo.new(0.3), {Size = UDim2.new(1, -12, 0, 32)}):Play()
